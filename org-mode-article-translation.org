...
这篇文档假定你已经对org-mode有了初步了解，因此像agenda，capture mode等概念对你来说并不完全陌生。更多关于org-mode的信息可以在 [[http://orgmode.org/index.html#sec-4.1][Org-Mode Manual]] 和 [[http://orgmode.org/worg/][Worg Site]] 上找到。
...
我已经使用org-mode管理我的个人信息很多年了。起初我只是使用默认的 =TODO= 和 =DONE= 关键词，后来我对自己的工作流作了小的修改。经过多年的完善，就形成了这篇文档的内容。
...
我仍然在完善我的工作流并且经常尝试新的内容。这篇文档阐述了我当前org-mode设置中的成熟的工作流。
